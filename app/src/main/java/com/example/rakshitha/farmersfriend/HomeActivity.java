...
public class HomeActivity extends AppCompatActivity
        ...
        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    Farmers farmers = snapshot.getValue(Farmers.class);
                    item_list.add(farmers);
                }
                adapter = new HomeAdapter(HomeActivity.this, item_list);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_crop) {
            startActivity(new Intent(HomeActivity.this,CropPrediction.class));

        }
        else if (id == R.id.nav_puzzle) {
            startActivity(new Intent(HomeActivity.this,PuzzleActivity.class));
